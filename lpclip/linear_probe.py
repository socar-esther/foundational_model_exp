...
# val_shot_list = {1: 1, 2: 2, 4: 4, 8: 4, 16: 4} # linear layer 학습은 train 전체 사용

# train set으로 linear probe 학습하는 방식으로 변경한다 (train shot)
for num_shot in [1500]:
    ...
    for seed in range(1, args.num_run + 1):
        ...
        selected_idx_list = []
        print('> check train gt unique list:', all_label_list)
        ...
        for label in all_label_list:
            ...
            val_selected_idx_list.extend(label_collection)
